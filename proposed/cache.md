...
Cache\CacheItemPoolInterface and Cache\CacheItemInterface interfaces. Implementing
Libraries MUST support at minimum TTL functionality as described below with
...
Cache\CacheItemPoolInterface object, which is responsible for any required setup
as well as associating the object with a unique Key. Cache\CacheItemInterface
objects MUST be able to store and retrieve any type of PHP value defined in the
...
/**
 * \Psr\Cache\CacheItemPoolInterface generates Cache\CacheItemInterface objects.
 */
interface CacheItemPoolInterface
{
     ...
     *
     * This method must always return a CacheItemInterface object, even in the
     * case of a cache miss. It MUST NOT return null.
     *
     * @param string $key
