...
выбрасывать исключение Psr\Log\InvalidArgumentException, если уровень не осуществлен. 
Пользователи не должны использовать свой уровень не зная наверняка что данная реализация поддерживает его.
...
Вызов этого метода с одним из журнала уровня константы должны иметь
тот же результат вызова метода конкретного уровня.
